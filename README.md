...
> **기준일:** 2026-09-22
> **상태:** **v1.0 공개 배포 중 · v1.1 준비 중** — [Releases](https://github.com/Hyunjin-Cho/ddak-a/releases)에서 받을 수 있는 것은 아직 **v1.0** 이다 (앱·DMG 모두 Apple 공증 완료)

<!-- 🔒 2026-09-22 (PR #1 리뷰 F-3): 위 상태 줄과 아래 "v1.1부터는 …" 문장은 반드시 같이 움직인다.
     이 문서는 v1.1 동작을 현재형으로 안내하는데 Releases 에 올라간 것은 v1.0 이라, 그 사이 기간에
     받아서 써 본 사람에게는 "설명대로 안 된다"가 된다.
     릴리스하는 날 할 일: 상태 줄에서 "· v1.1 준비 중"을 떼고 v1.1 로 올린다. -->
...
> (v1.1 릴리스 전까지는 받은 앱에 이 동작이 없다 — 위 상태 줄 참고)
