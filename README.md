...
> **기준일:** 2026-09-22
> **상태:** 배포 준비 — 기능 확정, 서명·공증 파이프라인 구축 완료
...
> 다른 경로에 복사해서 실행한다(App Translocation). 그런데 **손쉬운 사용·입력 모니터링
> 권한은 앱의 경로를 함께 기억**하기 때문에, 실행할 때마다 경로가 달라지면
> **권한을 켜도 계속 안 켜진 것처럼 동작한다.**
>
> 응용 프로그램 폴더로 직접 옮기면 이 동작이 풀려 경로가 고정된다.
